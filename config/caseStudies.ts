...
export const caseStudies: CaseStudy[] = [
	// -------------------------------------------------------------------------
	{
		...
		blocks: [
			...
			{ t: 'media', img: '/work/portoro/2.webp', text: 'Portoro property discovery — search results' },
	...
	// -------------------------------------------------------------------------
	{
		...
		meta: [
			...
			{ label: 'Context', value: 'Katapult — multi-client enablement' },
		],
		blocks: [
			...
			{ t: 'ol', items: [
				...
				'Brand is data, never code — visual identity lives in one client-theme.json; hardcoded colors are treated as defects.',
			...
			{ t: 'h', text: 'The loop (the heart of it)' },
			...
			{ t: 'ul', items: [
				...
				'Theme engine: createTheme.js interpolates full 50–950 color ramps and semantic ads.* tokens (light/dark) from a single brand seed — so re-skinning a client is one file.',
